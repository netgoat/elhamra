 ...
 */
    ...
    /**
     *
     * @Vich\UploadableField(mapping="programs_attachement", fileNameProperty="attachement")
     * @Assert\File(
     ...
     * @ORM\JoinTable(name="programs_performances",
    ...
    */
     ...
     * @ORM\JoinTable(name="programs_galleries",
     *      joinColumns={@ORM\JoinColumn(name="program_id", referencedColumnName="id")},
